            ...
            <section class="users-edit">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="form-validate" action="{{ route('roles.store') }}" method="POST">
                            @csrf
                            <div class="row">
                                        ...
                                        <table class="table mt-1">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="checkbox">
                                                            <input class="checkbox-input" id="{{$group.'-'.$permision_read}}" name="permission[]" type="checkbox" value="{{$permision_read}}">
                                                            <label for="{{$group.'-'.$permision_read}}"></label>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="checkbox">
                                                            <input class="checkbox-input" id="{{$group.'-'.$permission_create}}" name="permission[]" type="checkbox" value="{{$permission_create}}">
                                                            <label for="{{$group.'-'.$permission_create}}"></label>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="checkbox">
                                                            <input class="checkbox-input" id="{{$group.'-'.$permission_edit}}" name="permission[]" type="checkbox" value="{{$permission_edit}}">
                                                            <label for="{{$group.'-'.$permission_edit}}"></label>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="checkbox">
                                                            <input class="checkbox-input" id="{{$group.'-'.$permission_delete}}" name="permission[]" type="checkbox" value="{{$permission_delete}}">
