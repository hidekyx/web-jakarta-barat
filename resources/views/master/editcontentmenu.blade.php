	...
	<div class="content-wrapper">
		...
		<div class="content-body">
			<div class="card-header">
				<i class="fa fa-plus"></i> Edit Content Menu
			</div>
			
			<form action="/update-menu/content/{{$item->id}}" method="post" class="add">
				<div class="card-block">
					@csrf
					<label for="basic-url" class="form-label">Input Nama Content</label>
					<div class="input-group mb-3">
						<span class="input-group-text">Nama Menu</span>
						<input type="text" class="form-control" required="required" value="{{$item->title_content}}" placeholder="Ketik disini" aria-label="Recipient's username" aria-describedby="basic-addon2" id="title_content" name="title_content">
					</div>
					...
					<div class="input-group mb-3">
						...
						<select required="required" class="form-control" name="id_menu" id="id_menu">
