...
<div class="app-content content">
	...
	<div class="content-wrapper">
		...
		<div class="content-body"><br><br>
			<div class="row">
				<div class="col-md-12">
					<a href="/tagsinput" class="btn btn-light-primary">Tambah Tag</a>
				</div>
			...
			<table class="table table-hover table-bordered table-responsive" id="tabel-data">
				...
				<tr>
					...
					<td>
						...
						<a class="btn-table btn-warning" href="/tagsedit/{{ $post->id }}"><i class="fas fa-edit"></i></a>
					</td>
				</tr>
				@endforeach
				<script>
