		...
		<div class="content-body">
			...
			<form action="/popup-set/update/{{ $p->id }}" method="post" class="add" enctype="multipart/form-data">
				<div class="card-block">
					...
					<div class="input-group mb-3">
						<span class="input-group-text">Link Pop Up</span>
						<input type="text" class="form-control" required="required" value="{{ $p->ket }}" placeholder="Ketik disini" aria-label="Recipient's username" aria-describedby="basic-addon2" id="ket" name="ket">
					</div>
