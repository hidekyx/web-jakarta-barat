...
<div class="app-content content">
    <div class="content-overlay"></div>
        ...
        <div class="content-header row"></div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <a href="/kontributor/tambah-berita" class="btn btn-light-primary">Tambah Berita</a>
                </div>
            ...
            <thead class="bg-dark">
                ...
                @endif
                    ...
                    @endif
                    <td align="center">
                        <a class="btn-table btn-info" href="/kontributor/detail/berita/{{ $post->id }}"><i class="fas fa-info "></i></a>
                        @if ($post->published == 'N')
                        <a class="btn-table btn-warning" href="/kontributor/edit/berita/{{ $post->id }}"><i class="fas fa-edit"></i></a>
                    ...
                    function deleteConfirmation(id) {
                        swal({
                            ...
                            if (e.value === true) {
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url: "{{ url('/kontributor/delete/berita') }}/" + id,
                                    data: {
                                        _token: CSRF_TOKEN
                                    },
                                    dataType: 'JSON',
