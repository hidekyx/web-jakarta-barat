...
<div class="app-content content">
    ...
    <div class="content-body">
        ...
        @endif
        <form action="/kontributor/store-berita" method="post" class="add" enctype="multipart/form-data">
            <div class="card-block">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" required="required" placeholder="Ketik di sini" id="title" name="title" maxlength="150">
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="date" class="form-control" placeholder="Time" required="required" id="time" name="time">
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" required="required" placeholder="Ketik di sini" id="caption" name="caption" maxlength="150">
                </div>

                <label for="basic-url" class="form-label">Input Nama Narahubung</label>
                <div class="input-group mb-3">
                    <span class="input-group-text">Nama Lengkap</span>
                    <input type="text" class="form-control" required="required" placeholder="Ketik di sini" id="nama_narahubung" name="nama_narahubung" maxlength="150">
                </div>

                <label for="basic-url" class="form-label">No Kontak Narahubung</label>
                <div class="input-group mb-3">
                    <span class="input-group-text">No Kontak</span>
                    <input type="number" class="form-control" required="required" placeholder="Ketik di sini" id="no_kontak_narahubung" name="no_kontak_narahubung" maxlength="150">
                </div>
