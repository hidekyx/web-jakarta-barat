...
<div class="app-content content">
		...
		<div class="content-wrapper">
				...
				<div class="content-body">
                    ...
                    @endif
                    <form action="/kontributor/update/berita/{{ $editberita->id }}" method="post" class="add" enctype="multipart/form-data">
                    <div class="card-block">
                      @csrf
                          ...
                          <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" required="required" value="{{ $editberita->title }}" placeholder="Ketik di sini" id="title" name="title" maxlength="150">
                          </div>
                          ...
                          <div class="input-group mb-3">
                            ...
                            <input type="date" class="form-control" value="{{ $editberita->time }}" placeholder="Time" required="required" id="time" name="time">
                          </div>
                          ...
                          <div class="input-group mb-3">
                              ...
                              @if($editberita->img != null || $editberita->img != "")
                              <img src="{{  asset('storage/berita/'.$editberita->img)  }}" width="50%" id="file_utama_preview" class="img-thumbnail">
                              @else
                          ...
                          <div class="row">
                            <div class="col">
                                <div class="input-group mb-3">
                                    ...
                                    @if($editberita->img_2 != null || $editberita->img_2 != "")
                                    <img src="{{  asset('storage/berita/'.$editberita->img_2)  }}" width="80%" id="file_2_preview" class="img-thumbnail">
                                    @else
                            ...
                            <div class="col">
                                <div class="input-group mb-3">
                                    ...
                                    @if($editberita->img_3 != null || $editberita->img_3 != "")
                                    <img src="{{  asset('storage/berita/'.$editberita->img_3)  }}" width="80%" id="file_3_preview" class="img-thumbnail">
                                    @else
                            ...
                            <div class="col">
                                <div class="input-group mb-3">
                                    ...
                                    @if($editberita->img_4 != null || $editberita->img_4 != "")
                                    <img src="{{  asset('storage/berita/'.$editberita->img_4)  }}" width="80%" id="file_4_preview" class="img-thumbnail">
                                    @else
                        ...
                        $('input[type="file"]').change(function(e) {
                          ...
                          <label for="basic-url" class="form-label">Upload Video (Maks: 20MB)</label>
                          <div class="input-group mb-3">
                            <input type="file" class="form-control" id="video" value="{{ $editberita->video }}" name="video">
                          ...
                          <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" required="required" value="{{ $editberita->caption }}" placeholder="Ketik di sini" id="caption" name="caption" maxlength="150">
                          </div>

                          <label for="basic-url" class="form-label">Input Nama Narahubung</label>
                          <div class="input-group mb-3">
                              <span class="input-group-text">Nama Lengkap</span>
                              <input type="text" class="form-control" required="required" value="{{ $editberita->nama_narahubung }}" placeholder="Ketik di sini" id="nama_narahubung" name="nama_narahubung" maxlength="150">
                          </div>

                          <label for="basic-url" class="form-label">No Kontak Narahubung</label>
                          <div class="input-group mb-3">
                              <span class="input-group-text">No Kontak</span>
                              <input type="number" class="form-control" required="required" value="{{ $editberita->no_kontak_narahubung }}" placeholder="Ketik di sini" id="no_kontak_narahubung" name="no_kontak_narahubung" maxlength="150">
                          </div>
