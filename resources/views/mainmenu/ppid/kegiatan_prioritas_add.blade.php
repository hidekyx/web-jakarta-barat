...
<div class="content-wrapper">
    ...
    <div class="content-body">
        <div class="card-header">
            <i class="fa fa-plus"></i>Tambah Kegiatan Prioritas Baru
        </div>
        <form action="/kegiatan-prioritas/store" method="post" class="add" enctype="multipart/form-data">
        <div class="card-block">
            @csrf
            <label for="basic-url" class="form-label">Input Judul</label>
            <div class="input-group mb-3">
                <span class="input-group-text">Judul Kegiatan</span>
                <input type="text" class="form-control" required="required" placeholder="Ketik Disini" id="judul" name="judul" autocomplete="off">
            </div>

            <label for="basic-url" class="form-label">Input Caption</label>
            <div class="input-group mb-3">
                <span class="input-group-text">Caption Kegiatan</span>
                <input type="text" class="form-control" required="required" placeholder="Ketik Disini" id="caption" name="caption" autocomplete="off">
            </div>

            <label for="basic-url" class="form-label">Input Tanggal/Jam</label>
            <div class="input-group mb-3">
                <span class="input-group-text">Tanggal/Jam Publikasi</span>
                <input type="datetime-local" class="form-control" required="required" placeholder="Ketik Disini" id="tanggal" name="tanggal">
            </div>

            <label for="basic-url" class="form-label">Upload Media</label>
            <div class="input-group mb-3">
                <input type="file" class="form-control" required="required" id="file" name="file" accept="image/*, video/*">
