...
<div class="content-wrapper">
    ...
    <div class="content-body">
        <div class="card-header">
            <i class="fa fa-plus"></i>Tinjau Pengajuan Keberatan Informasi
        </div>
        @foreach($data as $d)
        <div class="card-block">
            ...
            <form action="/layanan-info-publik/pengajuan-keberatan/simpan" method="post" class="add" enctype="multipart/form-data">
            @csrf
                <input type="hidden" name="id_permohonan" value="{{ $d->id_permohonan }}">
                <input type="hidden" name="id_keberatan" value="{{ $d->id_keberatan }}">
