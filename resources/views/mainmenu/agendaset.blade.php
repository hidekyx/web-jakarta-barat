...
<div class="app-content content">
	...
	<div class="content-wrapper">
		...
		<div class="content-body"><br><br>
			<div class="row">
				<div class="col-md-12">
					<a href="/agenda/add" class="btn btn-light-primary">Tambah Agenda</a>
				</div>
			...
			<table class="table table-responsive" id="tabel-data">
				<thead class="bg-dark">
					<tr>
						...
						<th class="text-white">Pelaksana</th>
						<th class="text-white">Acara</th>
				...
				<tr>
					...
					<td>{{ $p->pelaksana }}</td>
					<td>{{ $p->acara }}</td>
					<td>{{ $p->tanggal }}<p>{{$p->pukul}} WIB</p></td>
					@if ( $p->aktif == 'N')
					...
					@endif
						<td>
							<a class="btn-table btn-warning" href="/agenda-detail/{{ $p->id }}">
								<i class="fas fa-edit"></i>
							</a>
							<a class="btn-table btn-danger" onclick="deleteConfirmation({{$p->id}})">
				...
				<script type="text/javascript">
					function deleteConfirmation(id) {
						swal({
							...
							text: "Agenda yang telah dihapus tidak akan bisa dikembalikan",
							type: "warning",
							showCancelButton: !0,
