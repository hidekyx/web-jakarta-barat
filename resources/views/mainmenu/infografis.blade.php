...
<div class="app-content content">
    ...
    <div class="content-wrapper">
        ...
        <div class="content-body"><br><br>
            <div class="row">
                <div class="col-md-12">
                    <a href="/addinfografis" class="btn btn-light-primary">Tambah Infografis</a>
                </div>
            ...
            <table class="table table-hover table-bordered table-responsive" id="tabel-data">
                ...
                <tr>
                    ...
                    <td>{{ $post->nama }}</td>
                    <td>{{ $post->link }}</td>
                    <td><img height="100px" style="object-fit: contain" src="{{  asset('storage/banner/'.$post->img)  }}" alt=""></td>
                    <td>
                        <a class="btn-table btn-warning" href="/editinfografis/{{$post->id}}"><i class="fas fa-edit"></i></a>
                ...
                <script type="text/javascript">
                    function deleteConfirmation(id) {
                        swal({
                            ...
                            text: "Infografis yang telah dihapus tidak akan bisa dikembalikan",
                            type: "warning",
                            showCancelButton: !0,
