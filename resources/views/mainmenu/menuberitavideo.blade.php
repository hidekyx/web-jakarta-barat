...
<div class="app-content content">
    ...
    <div class="content-wrapper">
        ...
        <div class="content-body"><br><br>
            <div class="row">
                <div class="col-md-12">
                    <a href="/masterberitavideo" class="btn btn-light-primary">Tambah Berita Video</a>
                </div>
            ...
            <table class="table table-hover table-bordered table-responsive" id="tabel-data">
                ...
                @endif
                    ...
                    @endif
                        <td align="center">
                            @if ($hasRole == true) 
                                <a class="btn-table btn-warning" href="/masterberitavideo/{{ $post->id }}"><i class="fas fa-edit"></i></a>
                            ...
                            @endif
                            @endif
                                <a class="btn-table btn-info" href="/menuberitavideo/{{ $post->id }}"><i class="fas fa-info "></i></a>
                        </td>
                    </tr>
                @endforeach
