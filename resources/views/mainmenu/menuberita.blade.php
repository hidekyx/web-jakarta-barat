...
<div class="app-content content">
    ...
    <div class="content-wrapper">
        ...
        <div class="content-body"><br><br>
            <div class="row">
                <div class="col-md-12">
                    <a href="/masterberita" class="btn btn-light-primary">Tambah Berita</a>
                </div>
            ...
            <table class="table table-hover table-bordered table-responsive" id="tabel-data">
                ...
                @endif
                    ...
                    <td align="center">
                        @if ($hasRole == true) 
                            <a class="btn-table btn-warning" href="/menuberitaupdate/{{ $post->id }}"><i class="fas fa-edit"></i></a>
                            <!-- <a class="btn-table btn-warning" onclick="editConfirmation({{ $post->id }})"><i class="fas fa-edit"></i></a> -->
                            <a class="btn-table btn-danger" onclick="deleteConfirmation({{ $post->id }})"><i class="fas text-white fa-trash"></i></a>
                        @elseif ($hasRole == false)
                        @if ($post->published == 'N')
                            <a class="btn-table btn-warning" href="/menuberitaupdate/{{ $post->id }}"><i class="fas fa-edit"></i></a>
                            <!-- <a class="btn-table btn-warning" onclick="editConfirmation({{ $post->id }})"><i class="fas text-white fa-edit"></i></a> -->
                        @endif
                        @endif
                            <a class="btn-table btn-info" href="/menuberita/{{ $post->id }}"><i class="fas fa-info "></i></a>
                    </td>
                </tr>
                @endforeach
                ...
                <script type="text/javascript">
                    function editConfirmation(id) {
                        swal({
                            ...
                            text: "Berita yang telah diedit akan mantap",
                            type: "warning",
                            showCancelButton: !0,
                            confirmButtonText: "Hapus",
                            cancelButtonText: "Batal",
