...
<div class="app-content content">
    ...
    <div class="content-wrapper">
        ...
        <div class="content-body">
        	<p>New Berita Video</p>
			<form action="/masterberitavideo/store" method="post" class="add" enctype="multipart/form-data">
                <div class="card-block">
					...
					<div class="input-group mb-3">
						...
						<input type="text" class="form-control" required="required" placeholder="Judul Berita" aria-label="Recipient's username" aria-describedby="basic-addon2" id="judul" name="judul">
					</div>

					<label for="basic-url" class="form-label">Tanggal</label>
					<div class="input-group mb-3">
						<span class="input-group-text">Tanggal</span>
						<input type="date" class="form-control" placeholder="Tanggal" required="required" aria-label="Recipient's username" aria-describedby="basic-addon2" id="tanggal" name="tanggal">
					</div>
					...
					<div class="input-group mb-3">
						...
						<input type="text" class="form-control" required="required" placeholder="Source" aria-label="Recipient's username" aria-describedby="basic-addon2" id="source" name="source">
					</div>

					<label for="basic-url" class="form-label">Input Deskripsi Berita</label>
					<div>
						<span class="input-group-text">Deskripsi Berita</span>
						<textarea class="form-control" name="deskripsi" id="tiny"></textarea>
					</div>
