...
<head>
    ...
    <title>Struktur Organisasi - Kota Administrasi Jakarta Barat</title>
</head>
<style>
    .dropdown-contentq {
    display: none;
            ...
            <div class="row row mt20 mb30">
                ...
                <div class="col-md-6 text-right pt-5" style="text-align: right;">
                    <ul class="breadcrumbq">
                        ...
                        <span style="color:#fff">/</span>
                        <span class="active">StrukturOrganisasi</span>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="container pt-5">
        <div class="row">
            <div class="col-md-8">
                ...
                <br>
                    <h5 style="font-family: popins-light; color: grey; text-align: justify">Struktur organisasi di Pemerintah Kota administrasi Jakarta Barat sama dengan struktur organisasi di pemerintah kota administrasi lainnya. Struktur organisasi tersebut telah ditetapkan dalam Peraturan Gubernur Provinsi DKI Jakarta No. 152 Tahun 2019 tentang Organisasi dan Tata Kerja Kota Administrasi.</li></h5>
                    <br>
                    <br>
                    <h5 style="font-family: popins-light; color: grey">Pergub tersebut dapat didownload <a href="https://drive.google.com/file/d/1p_nTsZPs2SEWWmuFxejCKU7uC_v9rquv/view?usp=sharing" style="color: black"> di sini</a></h5>
