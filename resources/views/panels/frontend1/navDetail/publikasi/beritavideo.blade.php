                    ...
                    <div class="px-2" style="overflow-x: auto;">
                        <table>
                            <tr>
                                ...
                                <div style="display: flex !important;" class="text-start">
                                    <div class="card" style="width: 50rem;">
                                        ...
                                        <div class="card-body" style="height: 100%">
                                            ...
                                            <div class="card-text">
                                                <p style="font-weight: bold; color:orangered;">{!! Str::limit($item->judul, 100) !!}</p>
                                                <p style="color: gray">{{ \Carbon\Carbon::parse($item->tanggal)->isoFormat('D MMMM Y')}}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
