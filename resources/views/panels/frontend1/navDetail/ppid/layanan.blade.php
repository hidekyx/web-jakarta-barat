<!DOCTYPE html>
    ...
    <meta charset="utf-8">
        ...
        <title>Layanan PPID - Kota Administrasi Jakarta Barat</title>
    </head>
    <style>
        .blogq{
            margin: 0 0 25px 0;
                ...
                <div class="col">
                    ...
                    <br>
                        <p class="blogq" style="color: #747474;">
                            <h4 style="box-sizing: border-box; outline: none; font-family: Montserrat, sans-serif; line-height: 30px; margin-top: 10px; margin-bottom: 10px; font-size: 18px; -webkit-font-smoothing: antialiased; background-color: #ffffff; font-weight: normal !important;"><span style="box-sizing: border-box; outline: none; font-weight: bold;">Layanan PPID</span></h4>
                            <ul>
                            <li style="box-sizing: border-box; list-style-type: circle; outline: none; color: #747474; font-family: 'Open Sans', sans-serif; background-color: #ffffff;">Alur Mekanisme Pelayanan Informasi Publik</li>
                            <li style="box-sizing: border-box; list-style-type: circle; outline: none; color: #747474; font-family: 'Open Sans', sans-serif; background-color: #ffffff;">Alur Mekanisme Pengelolaan Keberatan</li>
                            <li style="box-sizing: border-box; list-style-type: circle; outline: none; color: #747474; font-family: 'Open Sans', sans-serif; background-color: #ffffff;">Alur Mekanisme Permohonan Penyelesaian Sengketa Informasi</li>
                            <li style="box-sizing: border-box; list-style-type: circle; outline: none; color: #747474; font-family: 'Open Sans', sans-serif; background-color: #ffffff;">Alur Mekanisme Penanganan Sengketa Informasi</li>
                            <li style="box-sizing: border-box; list-style-type: circle; outline: none; color: #747474; font-family: 'Open Sans', sans-serif; background-color: #ffffff;">Kanal Pengaduan Resmi</li>
                            </ul>
                        </p>
