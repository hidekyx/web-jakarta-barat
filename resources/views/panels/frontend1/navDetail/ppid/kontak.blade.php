<!DOCTYPE html>
    ...
    <meta charset="utf-8">
        ...
        <title>Kontak PPID - Kota Administrasi Jakarta Barat</title>
    </head>
    <script
      src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAHR2Uy9DZD5XGuhxl3AoRWmXh6GWx6dCM&callback=initMap&v=weekly"
      async
    ></script>
    <script>
        let map;
        ...
        map = new google.maps.Map(document.getElementById("map"), {
            center: { lat: -6.186014, lng: 106.737614 },
            zoom: 8,
        });
        }
    </script>
                    ...
                    <br>
                        <p class="blogq" style="color: #747474;">
                            <h4 style="box-sizing: border-box; outline: none; font-family: Montserrat, sans-serif; line-height: 30px; margin-top: 10px; margin-bottom: 10px; font-size: 18px; -webkit-font-smoothing: antialiased; background-color: #ffffff; font-weight: normal !important;"><span style="box-sizing: border-box; outline: none; font-weight: bold;">
                                KONTAK PPID SEKRETARIAT KOTA ADMINISTRASI JAKARTA BARAT
                            </span></h4>
                            <p><span style="color: #747474; font-family: arial; font-size: large; background-color: #ffffff;">Jalan Raya Kembangan No.2, RT.2/RW.2, Kembangan Selatan Kec. Kembangan, Kota Jakarta Barat, Daerah Khusus Ibukota Jakarta 11610.</span><br style="box-sizing: border-box; outline: none; color: #747474; font-family: arial; font-size: large; background-color: #ffffff;" /><span style="color: #747474; font-family: arial; font-size: large; background-color: #ffffff;">No Telp/Fax : 021- 5821740</span><br style="box-sizing: border-box; outline: none; color: #747474; font-family: arial; font-size: large; background-color: #ffffff;" /><span style="color: #747474; font-family: arial; font-size: large; background-color: #ffffff;">Email : ppid.jakbar@jakarta.go.id atau ppid.barat@gmail.com</span></p>
                        </p>
                        <div id="map"></div>
