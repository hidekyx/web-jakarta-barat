...
Route::get('/ppid/{ket}', [PpidController::class, 'main']);
...
Route::get('kelurahan/{id}', [KecamatanController::class, 'kelurahan']);
...
Route::get('info-publik/{id}', [PPIDSetController::class, 'getByID']);
Route::get('info-publik-setting/new', [PPIDSetController::class, 'insertData']);
Route::post('/info-publik-setting/insert', [PPIDSetController::class, 'store']);
Route::post('/info-publik-setting/update/{id}', [PPIDSetController::class, 'update']);
...
Route::post('/masterberitafoto/update', 'BeritafotoController@update');
...
Route::post('deleteinfo/{id}', [PPIDSetController::class, 'delete']);
...
Route::get('info-publik-setting', [PPIDSetController::class, 'infoPublik']);
