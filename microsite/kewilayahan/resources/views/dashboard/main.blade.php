...
@else
    ...
    @elseif($page == "PPID")
        @isset($submenu)
            ...
            @elseif($submenu == "Prosedur Permohonan Pelayanan Informasi" || $submenu == "Prosedur Pengajuan Keberatan Informasi" || $submenu == "Prosedur Penanganan Sengketa Informasi" || $submenu == "Prosedur Permohonan Penyelesaian Sengketa Informasi")
