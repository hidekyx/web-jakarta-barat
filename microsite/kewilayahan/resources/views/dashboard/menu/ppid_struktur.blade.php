<main id="main" class="main">
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Manage Data - Struktur PPID</h5>
                    <form class="row g-3 needs-validation" id="form-struktur-ppid" method="post" action="{{ asset('dashboard/ppid/'.$subpage.'/simpan') }}" enctype="multipart/form-data" novalidate>
                    @csrf
                        <div class="col-md-12 position-relative">
                            <label for="struktur_organisasi" class="col-form-label">Bagan Struktur Organisasi</label>
                            <input class="form-control" type="file" id="struktur_organisasi" accept="image/*" name="struktur_organisasi">
                            @if($data_ppid)
                                @if($data_ppid->struktur_organisasi != null)
                                <img id="struktur_organisasi_preview" src="{{ asset('storage/files/images/foto/ppid_struktur_organisasi/'.$data_ppid->struktur_organisasi) }}" width="100%">
                                @endif
                            @else
