<main id="main" class="main">
    ...
    <div class="row">
        ...
        <form class="row needs-validation" id="form-profil" method="post" action="{{ asset('dashboard/informasi-wilayah/'.$subpage.'/simpan') }}" enctype="multipart/form-data" novalidate>
        @csrf
            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="quill-editor-default" id="profil" style="height: 50vh;">
                        @if($data_informasi)
                            {!! $data_informasi->konten !!}
                        @endif
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-pane fade show active profile-overview">
                            ...
                            <div class="row">
                                ...
                                @if($data_informasi)
                                    @if($data_informasi->status == "Menunggu Konfirmasi")
                                    <span class="badge bg-warning">Menunggu Konfirmasi</span>
                                    @elseif($data_informasi->status == "Sudah Dipublikasi")
