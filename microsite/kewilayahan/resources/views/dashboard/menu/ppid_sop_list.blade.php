<main id="main" class="main">
    <div class="pagetitle">
        ...
        <nav>
            ...
            <li class="breadcrumb-item active">SOP PPID</li>
            </ol>
        </nav>
    </div>
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card recent-sales overflow-auto">
                <div class="card-body">
                <h5 class="card-title">Data PPID - SOP PPID <span>| {{ $logged_user->nama }}</span></h5>
                ...
                <table class="table table-borderless table-striped table-hover datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{ asset('storage/files/images/foto/ppid_sop/'.$dp->file) }}"><button type="button" class="btn btn-sm btn-primary">Lihat File</button></a></td>
                    ...
                    <script type="text/javascript">
                        function delete_informasi(id_ppid) {
                            Swal.fire({
                            title: 'Hapus data SOP PPID ini?',
                            text: "Data SOP PPID yang dihapus tidak akan bisa dikembalikan!",
                            icon: 'warning',
                                ...
                                $.ajax({
                                    ...
                                    success: function(results) {
                                        if (results.success === true) {
                                            Swal.fire(
                                            'Berhasil',
                                            'Data SOP PPID berhasil dihapus',
                                            'success'
                                            )
                                    ...
                                    error: function(results) {
                                        ...
                                        icon: 'error',
                                        title: 'Gagal',
                                        text: 'Data SOP PPID tidak terhapus'
                                        })
                                    }
                                });
                            }
