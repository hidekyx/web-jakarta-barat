    ...
    <div class="contact-box sc-md-mb-10 sc-md-mt-45">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <input class="from-control troubleshooting_aplikasi_form" type="text" name="nama_pemohon_troubleshooting" placeholder="Isi Nama Lengkap Pemohon" required="" />
            </div>
            <div class="col-md-6">
                <b class="contact-title sc-pb-0 primary-color">NIP Pemohon</b>
                <input class="from-control troubleshooting_aplikasi_form" type="number" name="nip_pemohon_troubleshooting" placeholder="Isi NIP Pemohon" required="" />
            </div>
            <div class="col-md-6">
                <b class="contact-title sc-pb-0 primary-color">Jabatan</b>
                <input class="from-control troubleshooting_aplikasi_form" type="text" name="jabatan_pemohon_troubleshooting" placeholder="Isi Jabatan Pemohon" required="" />
            </div>
            ...
            <div class="col-md-6">
                ...
                <input class="from-control troubleshooting_aplikasi_form" type="number" name="no_hp_pemohon_troubleshooting" placeholder="Isi No HP Pemohon" required="" />
            </div>
            <div class="col-md-6">
                <b class="contact-title sc-pb-0 primary-color">Email Pemohon</b>
                <input class="from-control troubleshooting_aplikasi_form" type="email" name="email_pemohon_troubleshooting" placeholder="Isi Email Pemohon" required="" />
            </div>
            <div class="col-md-12">
