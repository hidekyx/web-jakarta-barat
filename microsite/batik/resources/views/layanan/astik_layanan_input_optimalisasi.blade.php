        ...
        @csrf
            <div class="row">
                ...
                function changeFunc() {
                    ...
                    $('#optimalisasi_perangkat').fadeOut("fast");
                    $('.optimalisasi_perangkat_form').prop("required", false);
                    ...
                    else if(kategori_value == "Optimalisasi Komputer / Laptop") {
                        $('#optimalisasi_perangkat').delay(100).fadeIn();
                        $('.optimalisasi_perangkat_form').prop("required", true);
                        $('#deskripsi_layanan').html('Layanan untuk meningkatkan kemampuan komputer / laptop agar kinerja berjalan secara maksimal');
                    }
                ...
                @include('layanan.astik_optimalisasi')
