    ...
    <div class="contact-box sc-md-mb-10 sc-md-mt-45">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <input class="from-control zoom_id_form" type="text" name="nama_pemohon_zoom_id" placeholder="Isi Nama Lengkap Pemohon" required="" />
            </div>
            <div class="col-md-6">
                <b class="contact-title sc-pb-0 primary-color">No HP / Email</b>
                <input class="from-control zoom_id_form" type="text" name="kontak_zoom_id" placeholder="Isi Kontak" required="" />
            </div>
