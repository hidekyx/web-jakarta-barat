    ...
    <div class="card-body pt-4 p-3">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 text-center">
                <h6 class="text-center text-sm">Hasil seleksi administrasi akan diumumkan pada tanggal <span class="text-info">12 Desember 2022</span></h6>
            </div>
            @endif
        @endif
    </div>
