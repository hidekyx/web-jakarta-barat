        ...
        <div class="info" data-aos="fade-right" data-aos-delay="100">
            <div class="row">
                <div class="form-group col-md-6 mb-4">
                    ...
                    <input type="text" name="nama_pemohon" class="form-control" id="nama_pemohon" placeholder="Isi Nama Pemohon" required>
                </div>
                <div class="form-group col-md-6 mb-4">
                    <label for="kontak" class="mb-2 label-form">No HP / Email</label>
                    <input type="text" class="form-control" name="kontak" id="kontak" placeholder="Isi Kontak" required>
                </div>
            </div>
