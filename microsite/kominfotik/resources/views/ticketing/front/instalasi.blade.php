<div id="instalasi" style="display: none;">
    ...
    <div class="mb-4 my-4">
        <div class="form-group">
            ...
            <input type="text" name="no_surat" class="form-control instalasi" id="no_surat" placeholder="Isi No Surat">
        </div>
    </div>
    ...
    <div class="mb-4">
        <div class="form-group">
            ...
            <input type="text" name="perihal_surat" class="form-control instalasi" id="perihal_surat" placeholder="Isi Perihal Surat">
        </div>
    </div>
