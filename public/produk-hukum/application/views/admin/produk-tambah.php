                                            ...
                                            <div class="row">
                                                <div class="col-md-12 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="position-relative">
                                                            <input type="text" name="title" class="form-control"id="first-name-icon" required oninvalid="this.setCustomValidity('Tidak Boleh Kosong!')" oninput="setCustomValidity('')">
                                                ...
                                                <div class="col-md-12 col-12">
                                                    <div class="form-group">
                                                        <label>Tentang:</label>
                                                        <div class="position-relative">
                                                            <textarea name="desc" class="form-control" required oninvalid="this.setCustomValidity('Tidak Boleh Kosong!')" oninput="setCustomValidity('')" style="height: 100px;"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4 col-12 row">
                                                    ...
                                                    <div class="form-group has-icon-left">
                                                        <div class="position-relative">
                                                            <input type="text" class="form-control datetimepicker-input" id="datepicker" data-toggle="datetimepicker" name="tanggal" data-target="#datepicker" required>
                                                ...
                                                <div class="col-md-4 col-12">
                                                    <div class="form-group">
                                                        <label>Nomor:</label>
                                                        <div class="position-relative">
                                                            <input type="number" name="nomor" class="form-control"id="first-name-icon" required oninvalid="this.setCustomValidity('Tidak Boleh Kosong!')" oninput="setCustomValidity('')">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4 col-12">
                                                    <div class="form-group">
                                                        <label>Tahun:</label>
                                                        <div class="position-relative">
                                                            <input type="number" name="tahun" class="form-control"id="first-name-icon" required oninvalid="this.setCustomValidity('Tidak Boleh Kosong!')" oninput="setCustomValidity('')">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 col-12 row">
                                                    ...
                                                    <fieldset class="form-group">
                                                        ...
                                                        <?php foreach($kategori as $kategoris){ ?>
                                                            <option value="<?php echo $kategoris->id_kategori; ?>"><?php echo $kategoris->nama_kat; ?></option>
                                                        <?php } ?>
                                                        </select>
                                                    </fieldset>
                                                </div>
                                                ...
                                                <div class="col-md-6 col-12 row">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="file" class="form-control" id=" upload_rider" name="path_file" onchange="loadFile(event)">
                                                        </div>
                                                    </div>
                                                </div>
