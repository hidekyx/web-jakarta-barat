		...
		<div class="container">
			...
			<div class="col-lg-9">
				<div class="comments-area">
					<h3 class="block-title"><a href="<?php echo base_url(); ?>" style="color: #7f7d8b;"><i class="fa fa-home"></i> Beranda</a><span style="color: #323268;"> / <?php echo $kategori->nama_kat; ?></span></h3>
