		...
		<div class="container">
			...
			<div class="col-lg-9">
				<div class="comments-area">
					<h3 class="block-title"><a href="<?php echo base_url(); ?>" style="color: #7f7d8b;"><i class="fa fa-home"></i> Beranda</a><span style="color: #323268;"> / Pencarian</span></h3>
					<ul class="comments-list">
						...
						<?php if($produk){ ?>
							...
							<?php } ?>
						<?php }else{ ?>
							<b><i><h3 class="text-center" style="margin-top: 20px;">Data Tidak Ditemukan</h3></i></b>
						<?php } ?>
